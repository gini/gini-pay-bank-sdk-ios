...
class DigitalInvoiceFooterCell: UITableViewCell {
    ...
    private func setup() {
        ...
        messageLabel.font = returnAssistantConfiguration?.digitalInvoiceFooterMessageTextFont ??
            ReturnAssistantConfiguration.shared.digitalInvoiceFooterMessageTextFont
